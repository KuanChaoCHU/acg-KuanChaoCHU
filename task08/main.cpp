...
int main() {
  ...
  while (!glfwWindowShouldClose(viewer.window)) {
    ...
    Eigen::MatrixXd rhs0 = matrix_laplacian.transpose() * matrix_laplacian * vtx_xyz_ref + penalty_coeff * matrix_penalty.transpose() * vtx_xyz_def; // write some code to compute rhs vector
